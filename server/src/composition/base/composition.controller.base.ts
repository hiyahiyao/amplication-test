...
export class CompositionControllerBase {
  ...
  async findManyPosition(
    ...
    const results = await this.service.findPosition(params.id, {
      where: query,
      select: {
        createdAt: true,
        id: true,
