...
export class UserControllerBase {
  ...
  async findManyComposition(
    ...
    const results = await this.service.findComposition(params.id, {
      where: query,
      select: {
        createdAt: true,
        id: true,
