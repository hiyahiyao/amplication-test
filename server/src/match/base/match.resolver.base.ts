...
export class MatchResolverBase {
  ...
  async createMatch(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        awayTeam: args.data.awayTeam
          ? {
              connect: args.data.awayTeam,
            }
          : undefined,

        homeTeam: args.data.homeTeam
          ? {
              connect: args.data.homeTeam,
            }
          : undefined,
      },
    });
  ...
  async awayTeam(
    ...
    const result = await this.service.getAwayTeam(parent.id);
  ...
  async homeTeam(
    ...
    const result = await this.service.getHomeTeam(parent.id);
